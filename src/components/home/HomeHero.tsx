        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left space-y-8">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full text-indigo-600 text-xs font-semibold tracking-wider"
            >
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 font-normal leading-relaxed"
            >
            ...
            >
              <Link to="/auth/login">
                <Button className="h-16 px-10 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-lg font-semibold tracking-tight shadow-2xl shadow-indigo-600/30 group">
                  Book Free Trial
                  <ArrowRight className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
              <Button variant="outline" className="h-16 px-8 rounded-2xl border-border/60 hover:bg-muted font-semibold tracking-tight flex items-center gap-3">
            ...
            >
              <div className="space-y-1">
                <div className="text-3xl font-bold tracking-tight">5K<span className="text-indigo-600">+</span></div>
                <div className="text-[10px] font-medium text-muted-foreground tracking-wider">Active Learners</div>
              </div>
              <div className="space-y-1">
                <div className="text-3xl font-bold tracking-tight">98<span className="text-indigo-600">%</span></div>
                <div className="text-[10px] font-medium text-muted-foreground tracking-wider">Success Rate</div>
              </div>
              <div className="space-y-1">
                <div className="text-3xl font-bold tracking-tight">120<span className="text-indigo-600">+</span></div>
                <div className="text-[10px] font-medium text-muted-foreground tracking-wider">Expert Mentors</div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex-1 relative w-full max-w-lg lg:max-w-none">
            ...
            >
              ...
              >
                ...
                <div className="text-[10px] font-semibold tracking-wider text-foreground">LIVE CLASSES NOW</div>
              </motion.div>
              ...
              >
                <div className="p-2 bg-indigo-500/10 rounded-lg text-indigo-600 font-bold text-xs">A+</div>
                <div className="text-[10px] font-semibold tracking-wider text-foreground">PREMIUM RESULTS</div>
              </motion.div>
            </motion.div>
          </div>
        </div>
