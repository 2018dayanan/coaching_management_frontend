    ...
    <footer className="bg-muted/30 border-t border-border/40 pt-20 pb-10">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          {/* Programs */}
          <div className="space-y-6">
            <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground opacity-60">Curriculum</h4>
            <ul className="space-y-4">
              <li><a href="#" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Primary Education</a></li>
              <li><a href="#" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Higher Secondary</a></li>
              <li><a href="#" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Entrance Preparation</a></li>
              <li><a href="#" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Competitive Exams</a></li>
            </ul>
          </div>

          {/* Support */}
          <div className="space-y-6">
            <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground opacity-60">Support</h4>
            <ul className="space-y-4">
              <li><a href="#" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Terms & Conditions</a></li>
              <li><a href="#" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Contact Support</a></li>
              <li><a href="#" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Portal Help</a></li>
            </ul>
          </div>

          {/* Contact */}
          <div className="space-y-6">
            <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground opacity-60">Visit Us</h4>
